...
export function ComingSoon({
  ...
  return (
    <div className="px-8 py-8 lg:px-12">
      ...
      <div className="rounded-md border border-admin-border bg-admin-surface p-8">
        <p className="text-[11px] uppercase tracking-[0.28em] text-admin-text-subtle">
          Phase 2+
        </p>
        <p className="mt-3 max-w-2xl text-sm leading-relaxed text-admin-text-muted">
          {description}
        </p>
      </div>
    </div>
